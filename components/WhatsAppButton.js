...
const handleWhatsAppClick = () => {
  ...
  let secondMessage = "Hello, I would like to inquire about your products";
  let finalMessage = "";
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <div className="relative flex flex-col items-end">
        {isOpen && (
          <div className="absolute bottom-14 right-0 bg-white rounded-lg shadow-lg p-4 text-sm whitespace-nowrap">
